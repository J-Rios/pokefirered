const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]    = {{EVO_LEVEL, 40, SPECIES_RAICHU},
    ...
    [SPECIES_VULPIX]     = {{EVO_LEVEL, 40, SPECIES_NINETALES},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF] = {{EVO_LEVEL, 40, SPECIES_WIGGLYTUFF},
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_LEVEL, 40, SPECIES_POLIWRATH},
    ...
    [SPECIES_WEEPINBELL] = {{EVO_LEVEL, 40, SPECIES_VICTREEBEL},
    ...
    [SPECIES_EXEGGCUTE]  = {{EVO_LEVEL, 40, SPECIES_EXEGGUTOR},
    ...
    [SPECIES_STARYU]     = {{EVO_LEVEL, 40, SPECIES_STARMIE},
    ...
    [SPECIES_SUNKERN]    = {{EVO_LEVEL, 40, SPECIES_SUNFLORA},
    ...
    [SPECIES_LOMBRE]     = {{EVO_LEVEL, 40, SPECIES_LUDICOLO},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_LUDICOLO}},
    [SPECIES_SEEDOT]     = {{EVO_LEVEL, 14, SPECIES_NUZLEAF}},
    [SPECIES_NUZLEAF]    = {{EVO_LEVEL, 40, SPECIES_SHIFTRY},
    ...
    [SPECIES_SKITTY]     = {{EVO_LEVEL, 40, SPECIES_DELCATTY},
